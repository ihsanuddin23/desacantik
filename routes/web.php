...
use App\Http\Controllers\Dashboard\SaranaTransportasiController;
use App\Http\Controllers\Dashboard\SaranaTempatTinggalController;
use App\Http\Controllers\Dashboard\DataDemografiController;
use App\Http\Controllers\Dashboard\DataDemografiRtController;
...
Route::name("dashboard.")->prefix("/dashboard")->middleware(["auth"])->group(function () {
    ...
    Route::get('/demografi/all', [DataDemografiController::class, 'index'])->name('dashboard.demografi.index');
    Route::get('/demografirt/all', [DataDemografiRtController::class, 'index'])->name('dashboard.demografirt.index');
    // sarana transportasi
    Route::resource("/saranatransportasi", SaranaTransportasiController::class);
    // sarana tempat tinggal
    Route::resource("/saranatempattinggal", SaranaTempatTinggalController::class);
    // fasilitas umum
