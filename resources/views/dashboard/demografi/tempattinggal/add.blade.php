...
@section('title', 'Add Sarana Tempat Tinggal')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Add New Sarana Tempat Tinggal</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.dashboard.demografi.index') }}">Sarana
                                    Tempat Tinggal</a></li>
                            <li class="breadcrumb-item active">Add Sarana Tempat Tinggal</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Form Add New Sarana Tempat Tinggal</h3>
                            </div>
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <form action="{{ route('dashboard.saranatempattinggal.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="keterangan_tempat_tinggal" name="keterangan_tempat_tinggal" rows="3"></textarea>
                                    </div>
