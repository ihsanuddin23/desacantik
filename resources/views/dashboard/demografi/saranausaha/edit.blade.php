...
@section('title', 'Edit Sarana Usaha')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Form Edit Sarana Usaha</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.dashboard.demografi.index') }}">Sarana
                                    Usaha</a></li>
                            <li class="breadcrumb-item active">Edit Sarana Usaha</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Form Edit Sarana Usaha</h3>
                            </div>
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <form action="{{ route('dashboard.saranausaha.update', $saranausaha->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="jenis_perusahaan"
                                            name="jenis_perusahaan" value="{{ $saranausaha->jenis_perusahaan }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="jumlah_volume_sarana_usaha"
                                            ...
                                            value="{{ $saranausaha->jumlah_volume_sarana_usaha }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan_sarana_usaha">Keterangan</label>
                                        <textarea class="form-control" id="keterangan_sarana_usaha" name="keterangan_sarana_usaha" rows="3">{{ $saranausaha->keterangan_sarana_usaha }}</textarea>
                                    </div>
