                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_belum_sekolah"
                                                    name="laki_belum_sekolah" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_belum_tamat_sd"
                                                    name="laki_belum_tamat_sd" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_tamat_sd"
                                                    name="laki_tamat_sd" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_diploma_1_2"
                                                    name="laki_diploma_1_2" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_diploma_3"
                                                    name="laki_diploma_3" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_diploma_4_strata_1"
                                                    name="laki_diploma_4_strata_1" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_strata_2"
                                                    name="laki_strata_2" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_strata_3"
                                                    name="laki_strata_3" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="laki_belum_mengisi"
                                                    name="laki_belum_mengisi" oninput="calculateLakiLaki()" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan"
                                                    name="perempuan" required readonly>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_belum_sekolah"
                                                    name="perempuan_belum_sekolah" oninput="calculatePerempuan()"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_belum_tamat_sd"
                                                    name="perempuan_belum_tamat_sd" required
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_tamat_sd"
                                                    name="perempuan_tamat_sd" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_sltp"
                                                    name="perempuan_sltp" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_slta"
                                                    name="perempuan_slta" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_diploma_1_2"
                                                    name="perempuan_diploma_1_2" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_diploma_3"
                                                    name="perempuan_diploma_3" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_strata_2"
                                                    name="perempuan_strata_2" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_strata_3"
                                                    name="perempuan_strata_3" required oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="perempuan_belum_mengisi"
                                                    name="perempuan_belum_mengisi" required
                                                    oninput="calculatePerempuan()">
                                            </div>
                                        </div>
                                    </div>
