...
@section('content')
    <div class="section-heading" style="margin-top: 0; padding-top: 10px;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-heading-2-title">
                            ...
                            <p class="links"><a href="{{ route('frontend.home') }}">Home <i
                                        class="las la-angle-right"></i></a> {{ $category->title }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="post-list-content">
                                ...
                                <ul class="entry-meta">
                                    <li class="post-author-img"><img
                                            ...
                                            alt="{{ $post->user->name }}" /></li>
                                    <li class="post-author"> <a
                                            href="{{ route('frontend.user', $post->user->username) }}">{{ $post->user->name }}</a>
                                    </li>
                                    <li class="entry-cat"><a href="{{ route('frontend.category', $post->category->slug) }}"
                                            class="category-style-1"><span
                                                class="line"></span>{{ $post->category->title }}</a></li>
                                    <li class="post-date"><span
                                            class="line"></span>{{ $post->created_at->format('F d, Y') }}</li>
                                </ul>
