        ...
        @forelse ($recentposts as $recentpost)
            <div class="post-list post-list-style4">
                ...
                <div class="post-list-content">
                    <ul class="entry-meta">
                        <li class="entry-cat">
                            <a href="{{ route('frontend.category', $recentpost->category->slug) }}"
                                class="category-style-1">{{ $recentpost->category->title }}</a>
                        </li>
                        <li class="post-date"> <span
                                class="line"></span>{{ $recentpost->created_at->format('F d, Y') }}</li>
                    </ul>
                    ...
                    <div class="post-btn">
                        <a href="{{ route('frontend.post', $recentpost->slug) }}" class="btn-read-more">Continue Reading
