...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/frontend2/themes/sederhana/assets/bootswatch/flatly/bootstrap.min.css') }}">
    ...
    <script type="text/javascript"
        src="{{ asset('assets/frontend2/themes/sederhana/assets/lightbox/js/lightbox-plus-jquery.min.js') }}"></script>
