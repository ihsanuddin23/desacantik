    ...
    <body class="skin-purle">
        <div class="wrapper">
            ...
            <div class="menu-layanan">
                <div class="container">
                    <!-- Add any menu content here if needed -->
                </div>
            </div>
            <!-- end menu layanan -->
                        ...
                        <div class="blog-section">
                            <div class="bread-body">
                                <div class="bread-content">
                                    ...
                                    <i class="fa fa-angle-right"></i> Kategori Berita <i class="fa fa-angle-right"></i>
                                    {{ $category->title }}
                                </div>
                            </div>
                            ...
                            <div class="paging text-center">
                                <div>
                                    Menampilkan halaman {{ $posts->currentPage() }} dari {{ $posts->lastPage() }}
                                </div>
                                {{ $posts->links() }} <!-- This will display pagination links -->
                            </div>
                        </div>
