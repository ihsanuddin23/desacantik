                                            ...
                                            @foreach ($saranas as $sarana)
                                                <tr>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->jenis_sarana_prasarana_transportasi }}
                                                    </td>
                                                    <td class="bg-white text-dark">{{ $sarana->kondisi_transportasi }}
                                                    </td>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->jumlah_volume_transportasi }}</td>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->keterangan_transportasi }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table id="tempatTinggalTable" class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($saranatempattinggal as $sarana)
                                                <tr>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->jenis_sarana_prasarana_tempat_tinggal }}
                                                    </td>
                                                    <td class="bg-white text-dark">{{ $sarana->kondisi_tempat_tinggal }}
                                                    </td>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->jumlah_volume_tempat_tinggal }}</td>
                                                    <td class="bg-white text-dark">
                                                        {{ $sarana->keterangan_tempat_tinggal }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            @else
                                <div class="table-responsive">
                                    <table id="fasilitasUmum" class="table table-bordered table-striped table-hover">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th style="width: 20%;">Jenis Sarana Prasarana</th>
                                                <th style="width: 30%;">Nama</th>
                                                <th style="width: 5%;">Jumlah Volume (m²)</th>
                                        ...
                                        <tbody>
                                            @foreach ($kependudukan as $penduduk)
                                                <tr>
                                                    ...
                                                    <td class="bg-white text-dark">
                                                        {{ $penduduk->jumlah_volume_kependudukan }}</td>
                                                    <td class="bg-white text-dark">
                                                        {{ $penduduk->keterangan_kependudukan }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            @else
                                <div class="table-responsive">
                                    <table id="pendidikan" class="table table-bordered table-striped table-hover">
                                        <thead class="thead-dark">
                                            <tr>
                                                <th style="width: 10%;">Jenis Pendidikan</th>
                                        ...
                                        <tbody>
                                            @foreach ($pendidikan as $pendidik)
                                                <tr>
                                                    <td class="bg-white text-dark">{{ $pendidik->jenis_pendidikan }}
                                                    </td>
                                                    <td class="bg-white text-dark">
                                                        <ul style="list-style-type: none; padding-left: 0;">
                                                            @php
                                                    ...
                                                    <td class="bg-white text-dark">
                                                        {{ $pendidik->jumlah_volume_pendidikan }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            @foreach ($saranausaha as $su)
                                                <tr>
                                                    ...
                                                    <td class="bg-white text-dark">
                                                        {{ $su->jumlah_volume_sarana_usaha }}</td>
