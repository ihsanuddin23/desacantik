    ...
    <div class="container">
        <div class="bread-body">
            <div class="bread-content">
                <a href="{{ route('frontend.home') }}"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-right"></i> Demografi
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="sosmed-share">
                                    <div class="social-footer">
                                        <a name="fb_share" href="http://www.facebook.com/sharer.php?u=https://cikedokan.sidepe.com/pageprofil-desa/sejarah-desa-cikedokan" target="_blank" class="fa fa-facebook"></a>
                                        <a href="http://twitter.com/share?url=https://cikedokan.sidepe.com/pageprofil-desa/sejarah-desa-cikedokan" target="_blank" class="fa fa-twitter"></a>
                                        <a href="https://api.whatsapp.com/send?text=https://cikedokan.sidepe.com/pageprofil-desa/sejarah-desa-cikedokan" target="_blank" class="fa fa-whatsapp"></a>
                                        <a href="https://t.me/share/url?url=https://cikedokan.sidepe.com/pageprofil-desa/sejarah-desa-cikedokan" target="_blank" class="fa fa-telegram"></a>
                                    </div>
                                </div>
